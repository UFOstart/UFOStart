...
class PictureUploadField(formfields.StringField):
    template = t_path("pictureupload.html")
...
class FileUploadField(PictureUploadField):
    template = t_path("fileupload.html")

class PictureGalleryUploadField(formfields.StringField):
    template = t_path("multifileupload.html")
...
class TagSearchField(formfields.TagSearchField):
    template = t_path("tagsearch.html")
...
class UniqueNameField(StringField):
    ...
    template = t_path("uniquename.html")
